...
const Setup = lazy<React.FC<SetupProps>>(() => import('./Setup').then(m => ({ default: m.Setup })));
const ReadingView = lazy<React.FC<ReadingViewProps>>(() => import('./components/ReadingView').then(m => ({ default: m.ReadingView })));
